...
//                   return   <FontAwesome name="user" style={styles.icons} onPress={()=>{this.moveIcon(3,1,position)}} color="orange" size={20} />
//                 }
//                 break;
//               case 2 : 
//                 if(this.state.position32 === position){
//                   return   <FontAwesome name="user" style={styles.icons} onPress={()=>{this.moveIcon(3,2,position)}} color="orange" size={20} />
//                 }
//                 break;
//               case 3 : 
//                 if(this.state.position33 === position){
//                   return   <FontAwesome name="user" style={styles.icons} onPress={()=>{this.moveIcon(3,3,position)}} color="orange" size={20} />
//                 }
//                 break;
//               case 4 :
//                 if(this.state.position34 === position){
//                   return   <FontAwesome name="user" style={styles.icons} onPress={()=>{this.moveIcon(3,4,position)}} color="orange" size={20} />
//                 }
//                 break;
//               }
//               break;
...
//             <Image style={{ width : 50,height : 40,marginLeft : 30,marginBottom : 10}} source={this.state.image1} />
//           </TouchableOpacity>
     
//           <View style={[Players.styles,{marginLeft : Dimensions.get("window").width/50,borderRightWidth : 1,marginTop : 2,backgroundColor:"red"}]}>
...
//             <Image style={{ width : 50,height : 40,marginLeft : 30,marginBottom : 10}} source={this.state.image2} />
//           </TouchableOpacity>
//           <View style={[Players.styles,{borderLeftWidth : 1,marginTop : 1.7,backgroundColor:"green"}]}>
...
//               </View>
//               <View style={[styles.item,styles.red,{backgroundColor : "white"}]}>  
...
//         <View style={row.Style}>
//           <View>
//           <View style={[Players.styles,{marginLeft : Dimensions.get("window").width/50,borderRightWidth : 1,backgroundColor:"blue"}]}>
...
//             <Image style={{ width : 50,height : 40,marginLeft : 30,marginTop : 10}} source={this.state.image4} />
//           </TouchableOpacity>
//           </View>
//          <View style={row.Style}>
//               <View style={styles.first}>
...
//           </View>
//           <View>
//             <View style={[Players.styles,{borderLeftWidth : 1,backgroundColor:"yellow"}]}>
...
//             <Image style={{ width : 50,height : 40,marginLeft : 30,marginTop : 10}} source={this.state.image3} />
//           </TouchableOpacity>
//           </View>
//         </View>
...
// // can you convert this code in react native expo app